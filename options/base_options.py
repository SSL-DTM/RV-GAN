...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/path/to/dataset', required=False, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--netG', type=str, default='hrnet', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128, unet_128_new | hrnet]')
        ...
        parser.add_argument('--crop_size', type=int, default=216, help='then crop to this size')
